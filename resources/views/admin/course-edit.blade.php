...
<div class="row justify-content-center">
    <div class="col-md-8">
       ...
       value="{{ old('start_date', $course->start_date ? $course->start_date->format('Y-m-d') : '') }}" required>
                            @error('start_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="alert alert-warning">
                        ...
                        <p class="mb-0">
                            Изменение даты начала курса может повлиять на существующие заявки.
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('admin.courses.show', $course) }}" class="btn btn-outline-secondary">
                            <i class="bi bi-eye"></i> Просмотр курса
                        </a>
                    </div>
                </form>
            </div>
